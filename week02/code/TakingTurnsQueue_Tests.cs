...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 1 - GetNextPerson() doesnt remove people with 0 turns left from the queue, causing an infinite loop.
    ...
    // Defect(s) Found: 1 - Adding a new person midway doesnt work correctly.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 1 - infinite turns not handled correctly.
    ...
    // Defect(s) Found: 1 - negative turn count represents infinite turns, but not handled correctly.
    ...
    // Defect(s) Found: 1 - GetNextPerson() does not throw InvalidOperationException when called on an empty queue.
